...
It organizes my project repositories into two groups:

- `Project-Casebooks` for written casebook documentation
- `Engineering-Files` for each project's technical and implementation files
...
| Ferrum Resonance | TBD | [Ferrum-Resonance-Casebook](Project-Casebooks/Ferrum-Resonance-Casebook) | Not included |

## Folders

- [Project-Casebooks](Project-Casebooks/README.md)
- [Engineering-Files](Engineering-Files/README.md)
